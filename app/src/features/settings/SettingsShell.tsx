...
function SettingsPage({ section, compatibility, settings = {}, onSetting, onHarnessSetting, onToolSetting, accounts = [], onAccountsChanged, onExportUsageCsv, composer, quota, quotaStatus, onRefreshQuota }: SettingsSharedProps & { readonly section: StudioSettingsSectionId }) {
  switch (section) {
...
export function SettingsShell({ section, onSection, onBack, compatibility, settings, onSetting, onHarnessSetting, onToolSetting, accounts = [], onAccountsChanged, onExportUsageCsv, composer, quota, quotaStatus, onRefreshQuota }: SettingsSharedProps & {
