...
export function ToolsSection({ sessionId, tools, enabled, pendingKey, onAction }: {
  ...
  return <details className="harness-disclosure"><summary><span className="disclosure-icon"><HarnessIcon kind="tools" /></span><span>Tools</span><small>{enabledCount} enabled</small></summary>
