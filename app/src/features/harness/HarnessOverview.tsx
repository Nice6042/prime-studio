...
export function HarnessOverview({ session, compatibility, details, pendingKey, hiddenNoticeIds, onOpenChild, onOpenActivity, onAction }: {
  ...
  return <div className="harness-overview">
    ...
    <section className="harness-agent-group" aria-labelledby="active-agents-title">
      <div className="harness-group-heading"><h2 id="active-agents-title">Active · {active.length}</h2><button type="button" onClick={onOpenActivity}>View all</button></div>
    ...
    <section className="harness-agent-group" aria-labelledby="done-agents-title">
      <div className="harness-group-heading"><h2 id="done-agents-title">Done · {done.length}</h2><button type="button" onClick={onOpenActivity}>View all</button></div>
