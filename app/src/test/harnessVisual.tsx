...
const details: HarnessPanelDetails = {
  ...
  notices: [],
  outputs: [{ id: "output", label: "Harness integration plan", path: "lanes/harness-integration.md", kind: "file" }],
  ...
  activity: [
    ...
    { id: "a2", occurredAtMs: now - 240_000, group: "Today", kind: "tool", title: "Workspace source scan", detail: "Completed", tool: { command: "rg --files app/src", status: "succeeded", durationMs: 840, files: ["app/src/features/harness/HarnessInspector.tsx"] } },
    { id: "a3", occurredAtMs: now - 120_000, group: "Today", kind: "file", title: "Harness panel updated", detail: "HarnessInspector.tsx", filePath: "app/src/features/harness/HarnessInspector.tsx" },
  ],
  children: {
    fidelity: { summary: "Compare the operational inspector against the approved Prime Studio handoff.", startedAtMs: now - 620_000, context: { usedTokens: 6_400, capacityTokens: 40_000 }, transcript: [{ id: "m1", actor: "Harness", occurredAtMs: now - 610_000, text: "Task accepted. Reading the handoff and current implementation." }, { id: "m2", actor: "Agent", occurredAtMs: now - 430_000, text: "The information hierarchy is mapped. Verifying keyboard and narrow-width behavior next." }], activity: [{ id: "ca1", occurredAtMs: now - 600_000, label: "Opened prototype handoff" }, { id: "ca2", occurredAtMs: now - 410_000, label: "Compared panel geometry" }], files: [{ id: "cf1", path: "app/src/features/harness/HarnessInspector.tsx", change: "modified" }], error: null },
