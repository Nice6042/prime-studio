...
export const FEATURE_ACCEPTANCE: readonly PackageFeatureAcceptance[] = Object.freeze([
  ...
  row("CP-06", "slash autocomplete filters above the composer and supports keyboard execution", "complete", ["composer.slash.select", "composer.slash.execute"]),
  ...
  row("ST-12", "Keyboard shortcuts page is generated from the same command registry that executes them", "complete"),
